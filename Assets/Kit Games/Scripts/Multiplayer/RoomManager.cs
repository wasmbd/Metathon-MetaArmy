...
namespace IRONHEADGames
{
    public class RoomManager : MonoBehaviourPunCallbacks
    {
        ...
        public void OnEnterRoomButtonClicked_School(int spawnIndex)
        {
            PlayerPrefs.SetInt("spawnindex", spawnIndex);
            ...
            // if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsKey(MultiplayerVRConstants.MAP_TYPE_KEY))
            {
                ...
                // if (PhotonNetwork.CurrentRoom.CustomProperties.TryGetValue(MultiplayerVRConstants.MAP_TYPE_KEY, out mapType))
                {
                    ...
                    if ((string)mapType == MultiplayerVRConstants.MAP_TYPE_VALUE_SCHOOL)
                    {
                        ...
                        SceneLoader.instance.LoadScene("Metathon Building", true);
        ...
        {
            RoomOptions roomOptions = new RoomOptions { MaxPlayers = 8, PlayerTtl = 1000 };
            string[] roomPropsInLobby = { MultiplayerVRConstants.MAP_TYPE_KEY };
            //Currently, there are 2 different maps: Outdoor and School
            //1.Outdoor = "outdoor"
            //2.School = "school"
            ...
            //By doing this, private rooms can be joined only by entering the room name which acts like a password
            roomOptions.IsVisible = false;
            PhotonNetwork.JoinOrCreateRoom("Room" + index, roomOptions, null);
        }
